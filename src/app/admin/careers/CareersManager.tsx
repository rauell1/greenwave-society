...
import { EXECUTIVE_LEADERS } from "@/lib/leaders";

const STAGES = ["new", "reviewing", "shortlisted", "interview", "accepted", "rejected"] as const;
const CURRENT_REVIEWER_NAMES = ["Martin Kyalo", "Njeri Njoroge", "Eugene Shadrack", "Roy Okola Otieno"] as const;
const REVIEWERS = EXECUTIVE_LEADERS.filter((leader) => (CURRENT_REVIEWER_NAMES as readonly string[]).includes(leader.name));
const PAGE_SIZE = 10;
