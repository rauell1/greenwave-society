...
export default function MemberActions({ memberId, status, emailStatus, notes, canUpdate, canReview }: { memberId: string; status: string; emailStatus: string | null; notes: Note[]; canUpdate: boolean; canReview: boolean }) {
