...
export const AUDIT_ACTIONS = {
  ...
  EVENT_ATTENDEES_EXPORTED: "EVENT_ATTENDEES_EXPORTED",
  ...
  CAREER_APPLICATION_UPDATED: "CAREER_APPLICATION_UPDATED",
  CAREER_APPLICATIONS_EXPORTED: "CAREER_APPLICATIONS_EXPORTED",
  CAREER_ROLE_UPDATED: "CAREER_ROLE_UPDATED",
  MEMBERSHIP_PAYMENTS_EXPORTED: "MEMBERSHIP_PAYMENTS_EXPORTED",
  MEMBERSHIP_PAYMENT_REFUND_INITIATED: "MEMBERSHIP_PAYMENT_REFUND_INITIATED",
} as const;
