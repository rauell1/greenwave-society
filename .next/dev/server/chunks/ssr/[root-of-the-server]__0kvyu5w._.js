...
const metadata = {
    ...
    description: "Greenwave Society empowers youth holistically to be changemakers and conserve the environment. Environmental conservation and climate action in Kenya and beyond.",
    keywords: [
        "Greenwave Society",
        "youth empowerment",
    ...
    openGraph: {
        title: "Greenwave Society | Empowering Youth & Conserving the Environment",
        description: "Greenwave Society empowers youth holistically to be changemakers and conserve the environment.",
        type: "website"
    },
    twitter: {
        card: "summary_large_image",
        title: "Greenwave Society",
        description: "Empowering Youth & Communities | Environmental Conservation and Climate Action"
    }
};
